...
$approveDisabled = ($status === 'active' || $status === 'approved') ? "disabled style='opacity:0.5;pointer-events:none;'" : "";
$disableDisabled = ($status === 'disabled') ? "disabled style='opacity:0.5;pointer-events:none;'" : "";
